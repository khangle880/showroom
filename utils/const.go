...
import "github.com/khangle880/showroom/models"

const (
	AppVersion     = "v0.1.0"
	AppName        = "Showroom CLI"
	AppDescription = "Showroom CLI is a CLI tool to get information about showrooms"
	...
	OnlivesApiURL  = LiveApiURL + "/onlives"
